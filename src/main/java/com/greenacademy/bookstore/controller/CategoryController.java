...
public class CategoryController {
	...
	public ModelAndView getCategory(ModelAndView model,@RequestParam(defaultValue = "0") Integer page,@RequestParam(defaultValue = "5") Integer size) {
...
//		List<Category> categories = this.categoryService.getAll();
	...
	public ModelAndView getCategory(@PathVariable("id")Long id, @RequestParam("mode") String mode , ModelAndView model) {
