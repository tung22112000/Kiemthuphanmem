...
public interface OrderRepository extends JpaRepository<Order, Long> {
	...
	List<Order> searchByHoursAndMinute(@Param("fromHour") int fromHour,@Param("fromMinute") int fromMinute, @Param("toHour") int toHour,@Param("toMinute") int toMinute);
	...
	List<Order> searchByDatesAndTime(@Param("fromDate") Date fromDate, @Param("fromHour") int fromHour, @Param("fromMinute") int fromMinute,@Param("toDate") Date toDate, @Param("toHour") int toHour, @Param("toMinute") int toMinute);
