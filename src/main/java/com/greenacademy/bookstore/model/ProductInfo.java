package com.greenacademy.bookstore.model;
...
public class ProductInfo {
	...
	public ProductInfo(Long id, String productName,  
			int oldPrice ,String productImages ,Integer newPrice ,Double discount,Integer yearManufactured,
