...
<link href="<c:url value="/resources/css/print.css" />"
	rel="stylesheet">
...
<div id="page" class="page">
    <div class="header">
        <div class="logo"><img
							src="<c:url value="/uploads/logoPrint1.png" />" height="130" width="200"></div>
        <div class="company">CỬA HÀNG SÁCH THANH PHONG
			<br><div><i class="fas fa-map-marker-alt"></i> Đia chỉ: 103 tăng nhơn phú, phước Long B, quận 9, TP.HCM</div>
			<div><i class="far fa-envelope"></i> Email: cuahangsachthanhphong@gmail.com  </div>
			<div><i class="fas fa-phone"></i> Liên hệ: 0392100200</div>
		</div>
    </div>
  <br/>
	...
	<div class="card">
		<div class="card-body">
			...
			<div class="row">
				...
				<div class="col">${order.customer.lastName} ${order.customer.firstName}</div>
			</div>
			<div class="row">
				<div class="col">
					<label>Địa chỉ:</label>
			...
			<h5><strong>Tóm lược đơn hàng của bạn:</strong></h5>
  ...
  <div class="footer-left"> ..., ngày ... tháng ... năm 2020<br/>
    Khách hàng </div>
  <div class="footer-right"> ..., ngày ... tháng ... năm 2020<br/>
    Nhân viên </div>
</div>
</body>
</html>